...
-type pool(XQG, XQH) :: {pool,
        fun((XQG, glisten@internal@handler:loop_message(XQH), glisten@internal@handler:connection(XQH)) -> glisten@internal@handler:next(XQG, glisten@internal@handler:loop_message(XQH))),
        integer(),
        fun((glisten@internal@handler:connection(XQH)) -> {XQG,
            gleam@option:option(gleam@erlang@process:selector(XQH))}),
        gleam@option:option(fun((XQG) -> nil)),
        glisten@transport:transport()}.

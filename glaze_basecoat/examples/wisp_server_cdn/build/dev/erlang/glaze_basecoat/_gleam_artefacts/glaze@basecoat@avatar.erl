...
-spec avatar(list(lustre@vdom@vattr:attribute(QAF))) -> lustre@vdom@vnode:element(QAF).
avatar(Attrs) ->
...
-spec rounded(list(lustre@vdom@vattr:attribute(QAJ))) -> lustre@vdom@vnode:element(QAJ).
rounded(Attrs) ->
    lustre@element@html:img(
        [lustre@attribute:class(
...
-spec initials(binary(), list(lustre@vdom@vattr:attribute(QAN))) -> lustre@vdom@vnode:element(QAN).
initials(Text, Attrs) ->

...
-spec field(
    list(lustre@vdom@vattr:attribute(RPK)),
    list(lustre@vdom@vnode:element(RPK))
) -> lustre@vdom@vnode:element(RPK).
...
-spec label(
    list(lustre@vdom@vattr:attribute(RPQ)),
    list(lustre@vdom@vnode:element(RPQ))
...
-spec description(
    list(lustre@vdom@vattr:attribute(RPW)),
    list(lustre@vdom@vnode:element(RPW))
) -> lustre@vdom@vnode:element(RPW).
...
-spec error(
    list(lustre@vdom@vattr:attribute(RQC)),
    list(lustre@vdom@vnode:element(RQC))
) -> lustre@vdom@vnode:element(RQC).
...
-spec with_label(
    binary(),
    binary(),
    lustre@vdom@vnode:element(RQI),
    list(lustre@vdom@vattr:attribute(RQI))
) -> lustre@vdom@vnode:element(RQI).

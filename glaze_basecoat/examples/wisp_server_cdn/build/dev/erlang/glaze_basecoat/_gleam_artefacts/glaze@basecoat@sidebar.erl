...
-spec sidebar(
    binary(),
    list(lustre@vdom@vattr:attribute(SPL)),
    list(lustre@vdom@vnode:element(SPL))
) -> lustre@vdom@vnode:element(SPL).
...
-spec nav(
    list(lustre@vdom@vattr:attribute(SPZ)),
    list(lustre@vdom@vnode:element(SPZ))
) -> lustre@vdom@vnode:element(SPZ).
nav(Attrs, Children) ->
...
-spec group(binary(), list(lustre@vdom@vnode:element(SQX))) -> lustre@vdom@vnode:element(SQX).
group(Label, Items) ->
...
-spec group_with_attrs(
    binary(),
    list(lustre@vdom@vattr:attribute(SRB)),
    list(lustre@vdom@vnode:element(SRB))
) -> lustre@vdom@vnode:element(SRB).
...
-spec link(
    binary(),
    boolean(),
    list(lustre@vdom@vattr:attribute(SRH)),
    list(lustre@vdom@vnode:element(SRH))
) -> lustre@vdom@vnode:element(SRH).
...
-spec button(
    boolean(),
    list(lustre@vdom@vattr:attribute(SRN)),
    list(lustre@vdom@vnode:element(SRN))
) -> lustre@vdom@vnode:element(SRN).
...
-spec submenu(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(SRT)),
    list(lustre@vdom@vnode:element(SRT))
) -> lustre@vdom@vnode:element(SRT).
...
-spec submenu_with_icon(
    binary(),
    lustre@vdom@vnode:element(SRZ),
    binary(),
    list(lustre@vdom@vattr:attribute(SRZ)),
    list(lustre@vdom@vnode:element(SRZ))
) -> lustre@vdom@vnode:element(SRZ).
...
-spec footer(
    list(lustre@vdom@vattr:attribute(SSG)),
    list(lustre@vdom@vnode:element(SSG))
) -> lustre@vdom@vnode:element(SSG).

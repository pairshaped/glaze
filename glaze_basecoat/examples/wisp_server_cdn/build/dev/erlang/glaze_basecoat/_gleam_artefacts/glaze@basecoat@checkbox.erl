...
-spec checkbox(list(lustre@vdom@vattr:attribute(QQQ))) -> lustre@vdom@vnode:element(QQQ).
checkbox(Attrs) ->
...
-spec with_label(binary(), binary(), list(lustre@vdom@vattr:attribute(QQU))) -> lustre@vdom@vnode:element(QQU).
...
-spec with_description(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(QQY))
) -> lustre@vdom@vnode:element(QQY).

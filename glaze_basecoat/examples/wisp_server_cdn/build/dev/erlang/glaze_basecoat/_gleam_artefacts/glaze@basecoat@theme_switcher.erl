...
-spec button(list(lustre@vdom@vattr:attribute(TKS))) -> lustre@vdom@vnode:element(TKS).
button(Attrs) ->
...
-spec button_with_tooltip(binary(), list(lustre@vdom@vattr:attribute(TKW))) -> lustre@vdom@vnode:element(TKW).

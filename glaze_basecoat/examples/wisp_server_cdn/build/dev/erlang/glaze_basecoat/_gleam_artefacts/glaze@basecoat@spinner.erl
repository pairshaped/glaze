...
-spec spinner(list(lustre@vdom@vattr:attribute(SYO))) -> lustre@vdom@vnode:element(SYO).
spinner(Attrs) ->
...
-spec overlay(
    list(lustre@vdom@vattr:attribute(SYW)),
    list(lustre@vdom@vnode:element(SYW))
) -> lustre@vdom@vnode:element(SYW).

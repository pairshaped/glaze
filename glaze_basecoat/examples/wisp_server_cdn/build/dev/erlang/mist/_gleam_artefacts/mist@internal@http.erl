...
?DOC(false).
-spec add_date_header(gleam@http@response:response(ABMW)) -> gleam@http@response:response(ABMW).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(ABMZ)) -> gleam@http@response:response(ABMZ).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(ABNC)) -> gleam@http@response:response(ABNC).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(ABNF)) -> gleam@http@response:response(ABNF).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(ABNK)) -> gleam@http@response:response(ABNK)).

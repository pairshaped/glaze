...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(HVC)),
    list(lustre@vdom@vnode:element(HVC))
) -> lustre@vdom@vnode:element(HVC).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HVI)),
    list(lustre@vdom@vnode:element(HVI))
) -> lustre@vdom@vnode:element(HVI).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HVO)),
    list(lustre@vdom@vnode:element(HVO)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(HVO).
...
-spec fragment(list(lustre@vdom@vnode:element(HVY))) -> lustre@vdom@vnode:element(HVY).
fragment(Children) ->
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(HWH))
...
-spec map(lustre@vdom@vnode:element(HWL), fun((HWL) -> HWN)) -> lustre@vdom@vnode:element(HWN).
map(Element, F) ->

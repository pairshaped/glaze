...
-type element(HKO) :: {fragment,
        integer(),
        binary(),
        list(element(HKO)),
        lustre@internals@mutable_map:mutable_map(binary(), element(HKO))} |
    {element,
        integer(),
        binary(),
        binary(),
        binary(),
        list(lustre@vdom@vattr:attribute(HKO)),
        list(element(HKO)),
        lustre@internals@mutable_map:mutable_map(binary(), element(HKO)),
        boolean(),
        boolean()} |
...
?DOC(false).
-spec to_keyed(binary(), element(HMC)) -> element(HMC).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    binary(),
    list(element(HKW)),
    lustre@internals@mutable_map:mutable_map(binary(), element(HKW))
) -> element(HKW).
...
-spec element(
    ...
    list(element(HLD)),
    lustre@internals@mutable_map:mutable_map(binary(), element(HLD)),
    boolean(),
    boolean()
) -> element(HLD).
element(
...
-spec unsafe_inner_html(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HLO)),
    binary()
) -> element(HLO).
...
?DOC(false).
-spec map(element(HLS), fun((HLS) -> HLU)) -> element(HLU).
map(Element, Mapper) ->
    case Element of
...
?DOC(false).
-spec memo(binary(), list(lustre@internals@ref:ref()), fun(() -> element(HLX))) -> element(HLX).
...
-spec fragment_to_json(
    ...
    binary(),
    list(element(HMF)),
    lustre@internals@mutable_map:mutable_map(fun(() -> element(HMF)), element(HMF))
) -> gleam@json:json().
...
-spec element_to_json(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HMF)),
    list(element(HMF)),
    lustre@internals@mutable_map:mutable_map(fun(() -> element(HMF)), element(HMF))
) -> gleam@json:json().

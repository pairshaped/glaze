...
-spec element(
    list(lustre@vdom@vattr:attribute(PIA)),
    list(lustre@vdom@vnode:element(PIA))
) -> lustre@vdom@vnode:element(PIA).
...
-spec include(lustre@vdom@vattr:attribute(PIM), list(binary())) -> lustre@vdom@vattr:attribute(PIM).
...
-spec subject(lustre:runtime(PIQ)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(PIQ)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(PIY))
) -> lustre@runtime@server@runtime:message(PIY).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(PJC))
) -> lustre@runtime@server@runtime:message(PJC).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(PJG)) -> nil)
) -> lustre@runtime@server@runtime:message(PJG).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(PJJ)) -> nil)
) -> lustre@runtime@server@runtime:message(PJJ).
...
-spec select(
    fun((fun((PJO) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(PJO))
) -> lustre@effect:effect(PJO).
select(Sel) ->

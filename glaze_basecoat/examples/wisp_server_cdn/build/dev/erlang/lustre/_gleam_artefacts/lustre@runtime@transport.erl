...
-export([client_message_to_json/1, mount/8, reconcile/2, emit/2, provide/2, attribute_changed/2, event_fired/3, property_changed/2, batch/1, context_provided/2, context_provided_decoder/0, server_message_decoder/0]).
...
-type client_message(JJZ) :: {mount,
        ...
        lustre@vdom@vnode:element(JJZ),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JJZ)), lustre@vdom@vnode:element(JJZ))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(JJZ),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JJZ)), lustre@vdom@vnode:element(JJZ))} |
...
-file("src/lustre/runtime/transport.gleam", 158).
?DOC(false).
-spec mount_to_json(
    integer(),
    boolean(),
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(JKZ),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JKZ)), lustre@vdom@vnode:element(JKZ))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
...
-file("src/lustre/runtime/transport.gleam", 184).
?DOC(false).
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(JLC),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JLC)), lustre@vdom@vnode:element(JLC))
) -> gleam@json:json().
...
-file("src/lustre/runtime/transport.gleam", 191).
?DOC(false).
...
-file("src/lustre/runtime/transport.gleam", 199).
?DOC(false).
...
-file("src/lustre/runtime/transport.gleam", 128).
?DOC(false).
...
-file("src/lustre/runtime/transport.gleam", 42).
?DOC(false).
-spec mount(
    boolean(),
    boolean(),
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(JKF),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JKF)), lustre@vdom@vnode:element(JKF))
) -> client_message(JKF).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
-file("src/lustre/runtime/transport.gleam", 67).
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(JKJ),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JKJ)), lustre@vdom@vnode:element(JKJ))
) -> client_message(JKJ).
...
-file("src/lustre/runtime/transport.gleam", 97).
?DOC(false).
...
-file("src/lustre/runtime/transport.gleam", 235).
?DOC(false).
...
-file("src/lustre/runtime/transport.gleam", 252).
?DOC(false).

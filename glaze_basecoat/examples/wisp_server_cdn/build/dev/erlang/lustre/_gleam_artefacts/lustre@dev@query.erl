...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(NCD)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NCD), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(NBY),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NBY), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(NDL)),
    selector()
) -> list(lustre@vdom@vnode:element(NDL)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(NDH), selector()) -> list(lustre@vdom@vnode:element(NDH)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(NDC)), 'query'()) -> list(lustre@vdom@vnode:element(NDC)).
...
-spec find_all(lustre@vdom@vnode:element(NCU), 'query'()) -> list(lustre@vdom@vnode:element(NCU)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(NCY), 'query'()) -> list(lustre@vdom@vnode:element(NCY)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(NDU)),
    selector()
) -> list(lustre@vdom@vnode:element(NDU)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(NDQ), selector()) -> list(lustre@vdom@vnode:element(NDQ)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(NBS)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NBS), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(NBI),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NBI), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(NBN),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NBN), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(NBD), 'query'()) -> {ok,
        lustre@vdom@vnode:element(NBD)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(NCO)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NCO), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(NCJ),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NCJ), lustre@vdom@path:path()}} |
    {error, nil}.

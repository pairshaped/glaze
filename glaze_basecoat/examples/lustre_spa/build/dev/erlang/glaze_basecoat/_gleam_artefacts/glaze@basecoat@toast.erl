...
-spec container(list(lustre@vdom@vattr:attribute(BYI))) -> lustre@vdom@vnode:element(BYI).
container(Attrs) ->
...
-spec container_aligned(alignment(), list(lustre@vdom@vattr:attribute(BYM))) -> lustre@vdom@vnode:element(BYM).
...
-spec toast(
    list(lustre@vdom@vattr:attribute(BYQ)),
    list(lustre@vdom@vnode:element(BYQ))
) -> lustre@vdom@vnode:element(BYQ).
...
-spec title(
    list(lustre@vdom@vattr:attribute(BZG)),
    list(lustre@vdom@vnode:element(BZG))
) -> lustre@vdom@vnode:element(BZG).
title(Attrs, Children) ->
    lustre@element@html:h2(Attrs, Children).

-file("src/glaze/basecoat/toast.gleam", 216).
-spec description(
    list(lustre@vdom@vattr:attribute(BZM)),
    list(lustre@vdom@vnode:element(BZM))
) -> lustre@vdom@vnode:element(BZM).
description(Attrs, Children) ->
    lustre@element@html:p(Attrs, Children).

-file("src/glaze/basecoat/toast.gleam", 223).
-spec content(
    list(lustre@vdom@vattr:attribute(BZS)),
    list(lustre@vdom@vnode:element(BZS))
) -> lustre@vdom@vnode:element(BZS).
content(Attrs, Children) ->
    lustre@element@html:section(Attrs, Children).

-file("src/glaze/basecoat/toast.gleam", 230).
-spec footer(
    list(lustre@vdom@vattr:attribute(BZY)),
    list(lustre@vdom@vnode:element(BZY))
) -> lustre@vdom@vnode:element(BZY).
footer(Attrs, Children) ->
    lustre@element@html:footer(Attrs, Children).

-file("src/glaze/basecoat/toast.gleam", 237).
-spec action_button(binary(), list(lustre@vdom@vattr:attribute(CAE))) -> lustre@vdom@vnode:element(CAE).
...
-spec cancel_button(binary(), list(lustre@vdom@vattr:attribute(CAI))) -> lustre@vdom@vnode:element(CAI).
...
-file("src/glaze/basecoat/toast.gleam", 263).

...
-type pool(ABKB, ABKC) :: {pool,
        fun((ABKB, glisten@internal@handler:loop_message(ABKC), glisten@internal@handler:connection(ABKC)) -> glisten@internal@handler:next(ABKB, glisten@internal@handler:loop_message(ABKC))),
        integer(),
        fun((glisten@internal@handler:connection(ABKC)) -> {ABKB,
            gleam@option:option(gleam@erlang@process:selector(ABKC))}),
        gleam@option:option(fun((ABKB) -> nil)),
        glisten@transport:transport()}.

...
?DOC(false).
-spec add_date_header(gleam@http@response:response(ADGY)) -> gleam@http@response:response(ADGY).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(ADHB)) -> gleam@http@response:response(ADHB).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(ADHE)) -> gleam@http@response:response(ADHE).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(ADHH)) -> gleam@http@response:response(ADHH).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(ADHM)) -> gleam@http@response:response(ADHM)).

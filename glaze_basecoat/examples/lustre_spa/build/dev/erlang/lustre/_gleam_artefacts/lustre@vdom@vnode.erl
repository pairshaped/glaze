...
-type element(HLR) :: {fragment,
        integer(),
        binary(),
        list(element(HLR)),
        lustre@internals@mutable_map:mutable_map(binary(), element(HLR))} |
    {element,
        integer(),
        binary(),
        binary(),
        binary(),
        list(lustre@vdom@vattr:attribute(HLR)),
        list(element(HLR)),
        lustre@internals@mutable_map:mutable_map(binary(), element(HLR)),
        boolean(),
        boolean()} |
...
?DOC(false).
-spec to_keyed(binary(), element(HNF)) -> element(HNF).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    binary(),
    list(element(HLZ)),
    lustre@internals@mutable_map:mutable_map(binary(), element(HLZ))
) -> element(HLZ).
...
-spec element(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HMG)),
    list(element(HMG)),
    lustre@internals@mutable_map:mutable_map(binary(), element(HMG)),
    boolean(),
    boolean()
) -> element(HMG).
element(
...
-spec unsafe_inner_html(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HMR)),
    binary()
) -> element(HMR).
...
?DOC(false).
-spec map(element(HMV), fun((HMV) -> HMX)) -> element(HMX).
map(Element, Mapper) ->
    case Element of
...
?DOC(false).
-spec memo(binary(), list(lustre@internals@ref:ref()), fun(() -> element(HNA))) -> element(HNA).
...
-spec fragment_to_json(
    ...
    binary(),
    list(element(HNI)),
    lustre@internals@mutable_map:mutable_map(fun(() -> element(HNI)), element(HNI))
) -> gleam@json:json().
...
-spec element_to_json(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HNI)),
    list(element(HNI)),
    lustre@internals@mutable_map:mutable_map(fun(() -> element(HNI)), element(HNI))
) -> gleam@json:json().

...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(HWF)),
    list(lustre@vdom@vnode:element(HWF))
) -> lustre@vdom@vnode:element(HWF).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HWL)),
    list(lustre@vdom@vnode:element(HWL))
) -> lustre@vdom@vnode:element(HWL).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HWR)),
    list(lustre@vdom@vnode:element(HWR)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(HWR).
...
-spec fragment(list(lustre@vdom@vnode:element(HXB))) -> lustre@vdom@vnode:element(HXB).
fragment(Children) ->
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(HXK))
) -> lustre@vdom@vnode:element(HXK).
...
-spec map(lustre@vdom@vnode:element(HXO), fun((HXO) -> HXQ)) -> lustre@vdom@vnode:element(HXQ).
map(Element, F) ->

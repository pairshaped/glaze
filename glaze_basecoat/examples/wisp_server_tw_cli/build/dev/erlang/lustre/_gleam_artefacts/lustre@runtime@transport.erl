...
-spec mount_to_json(
    ...
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JMC)), lustre@vdom@vnode:element(JMC))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(JMF),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JMF)), lustre@vdom@vnode:element(JMF))
) -> gleam@json:json().
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(JLI),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JLI)), lustre@vdom@vnode:element(JLI))
) -> client_message(JLI).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(JLM),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(JLM)), lustre@vdom@vnode:element(JLM))
) -> client_message(JLM).

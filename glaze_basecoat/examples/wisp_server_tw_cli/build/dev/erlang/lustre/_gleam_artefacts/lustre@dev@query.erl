...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(NDG)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NDG), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(NDB),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NDB), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(NEO)),
    selector()
) -> list(lustre@vdom@vnode:element(NEO)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(NEK), selector()) -> list(lustre@vdom@vnode:element(NEK)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(NEF)), 'query'()) -> list(lustre@vdom@vnode:element(NEF)).
...
-spec find_all(lustre@vdom@vnode:element(NDX), 'query'()) -> list(lustre@vdom@vnode:element(NDX)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(NEB), 'query'()) -> list(lustre@vdom@vnode:element(NEB)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(NEX)),
    selector()
) -> list(lustre@vdom@vnode:element(NEX)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(NET), selector()) -> list(lustre@vdom@vnode:element(NET)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(NCV)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NCV), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(NCL),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NCL), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(NCQ),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NCQ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(NCG), 'query'()) -> {ok,
        lustre@vdom@vnode:element(NCG)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(NDR)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(NDR), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(NDM),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(NDM), lustre@vdom@path:path()}} |
    {error, nil}.
